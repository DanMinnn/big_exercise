...
bool kt_ran_di_qua(int toadox[],int toadoy[],int x0, int y0);
//---------------
void tuongtren(){
	int x = 10,y = 1;
	while(x	<= 100){
...
bool kt_ran_cham_tuong(int x0, int y0){
	...
	// ran cham tuong duoi
	    ...
	    return true;
	// cham tuong phai 1
	else if(x0 == 100 && (y0 >= 1 && y0 <= 9))
	    return true;
	// cham tuong phai 2
	else if(x0 == 100 && (y0 >= 19 && y0 <= 26))
	    return true;
	// cham tuong trai 1
	else if(x0 == 10 && (y0 >= 1 && y0 <= 9))
	    return true;
	// cham tuong trai 2
	else if(x0 == 10 && (y0 >= 19 && y0 <= 26))
	    return true;
	// cham tuong trai
	// cham tuong giua tren
	else if(y0 == 9 && x0 >= 25 && x0 <= 85)
		return true;
	// cham tuong giua duoi
	else if(y0 == 19 && x0 >= 25 && x0 <= 85)
		return true;
	return false;
}
